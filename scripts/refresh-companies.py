...
# wedding concierge, not neptune.ai the ML experiment tracker. Both had live
# NYC roles, but listing them under the wrong company's name and description
# is the same error class as a wrong funding figure.
#
...
CANDIDATES = [
  ...
  ("fireworks","Fireworks AI","ashby","fireworks","ai","Fast inference for open models","Series B","$77M","Sequoia",["Sequoia","Benchmark","NVIDIA"],"Production inference platform for open-weights models. Systems + perf."),
  ...
  ("cocoon-hr","Cocoon","greenhouse","cocoon","saas","Leave management HR software","Series B","$40M","Index",["Index","Felicis","YC W22"],"YC W22."),
  ...
  ("tubi","Tubi","greenhouse","tubitv","media","Free streaming service","","","",[],""),
  ...
  # ── 2026-08-26 — 412-name sweep: construction, security, data/ML infra, climate, bio, aerospace, robotics ──
  ("clear-street","Clear Street","greenhouse","clearstreet","fintech","Prime brokerage technology","","","",[],""),
  ("linkup","Linkup","ashby","linkup","ai","Web search API","","","",[],""),
  ("adaptive-build","Adaptive Build","ashby","adaptive","fintech","Construction back office","","","",[],""),
  ("encord","Encord","ashby","encord","ai","Data annotation platform","","","",[],""),
  ("exa","Exa","ashby","exa","ai","Search API for AI","","","",[],""),
  ("absci","Absci","ashby","absci","ai","AI antibody design","","","",[],""),
  ("agave","Agave","ashby","agave","devtools","Construction data API","","","",[],""),
  ("albedo","Albedo","greenhouse","albedo","aerospace","Low-orbit imaging","","","",[],""),
  ("aligned-data-centers","Aligned Data Centers","ashby","aligned","infra","Sustainable data centers","","","",[],""),
  ("alpaca","Alpaca","greenhouse","alpaca","fintech","Brokerage API","","","",[],""),
  ("amperon","Amperon","greenhouse","amperon","ai","Energy forecasting","","","",[],""),
  ("anon","Anon","ashby","anon","ai","Authenticated agent actions","","","",[],""),
  ("antheia","Antheia","greenhouse","antheia","infra","Bio-manufactured molecules","","","",[],""),
  ("antithesis","Antithesis","ashby","antithesis","devtools","Autonomous software testing","","","",[],""),
  ("apex-space","Apex Space","greenhouse","apex","aerospace","Satellite buses","","","",[],""),
  ("apify","Apify","ashby","apify","devtools","Web scraping platform","","","",[],""),
  ("arc-institute","Arc Institute","greenhouse","arcinstitute","ai","Biomedical research","","","",[],""),
  ("arcee-ai","Arcee AI","greenhouse","arceeai","ai","Small language models","","","",[],""),
  ("armis","Armis","smartrecruiters","armis","infra","Asset intelligence security","","","",[],""),
  ("asimov","Asimov","ashby","asimov","infra","Synthetic biology design","","","",[],""),
  ("axelera-ai","Axelera AI","ashby","axelera","ai","Edge AI chips","","","",[],""),
  ("base-power","Base Power","ashby","base-power","infra","Home battery utility","","","",[],""),
  ("bild","Bild","ashby","bild-ai","ai","AI for construction management","","","",[],""),
  ("blink-ops","Blink Ops","ashby","blink","infra","Security automation","","","",[],""),
  ("brimstone","Brimstone","ashby","brimstone","infra","Carbon-negative cement","","","",[],""),
  ("britive","Britive","greenhouse","britive","infra","Cloud privilege management","","","",[],""),
  ("buildops","BuildOps","greenhouse","buildops","saas","Commercial contractor platform","","","",[],""),
  ("cala-health","Cala Health","greenhouse","calahealth","health","Wearable neuromodulation","","","",[],""),
  ("cambridge-mobile-telematics","Cambridge Mobile Telematics","greenhouse","cambridgemobiletelematics","ai","Driving behavior data","","","",[],""),
  ("camunda","Camunda","ashby","camunda","devtools","Process orchestration","","","",[],""),
  ("caribou-biosciences","Caribou Biosciences","ashby","caribou","health","Genome editing","","","",[],""),
  ("censys","Censys","greenhouse","censys","infra","Attack surface data","","","",[],""),
  ("chromatic","Chromatic","ashby","chromatic","devtools","Visual testing","","","",[],""),
  ("clarify-health","Clarify Health","lever","clarifyhealth","health","Healthcare analytics","","","",[],""),
  ("comet-ml","Comet ML","greenhouse","comet","ai","Experiment tracking","","","",[],""),
  ("corvus-robotics","Corvus Robotics","ashby","corvus-robotics","robotics","Warehouse drones","","","",[],""),
  ("couchbase","Couchbase","greenhouse","couchbaseinc","infra","NoSQL database","","","",[],""),
  ("cyberhaven","Cyberhaven","ashby","cyberhaven","infra","Data lineage security","","","",[],""),
  ("datagrail","DataGrail","greenhouse","datagrail","saas","Privacy management","","","",[],""),
  ("docker","Docker","ashby","docker","devtools","Container platform","","","",[],""),
  ("doxel","Doxel","lever","doxel","ai","Construction site tracking","","","",[],""),
  ("doximity","Doximity","greenhouse","doximity","health","Physician network","","","",[],""),
  ("dragos","Dragos","greenhouse","dragos","infra","Industrial cybersecurity","","","",[],""),
  ("dyna-robotics","Dyna Robotics","ashby","dyna-robotics","ai","Robot foundation models","","","",[],""),
  ("eko-health","Eko Health","lever","ekohealth","health","Digital stethoscope AI","","","",[],""),
  ("endor-labs","Endor Labs","greenhouse","endorlabs","infra","Software supply chain security","","","",[],""),
  ("energyhub","EnergyHub","greenhouse","energyhub","saas","Distributed energy management","","","",[],""),
  ("enode","Enode","ashby","enode","devtools","Energy device API","","","",[],""),
  ("etched","Etched","ashby","etched","ai","Transformer ASIC","","","",[],""),
  ("fate-therapeutics","Fate Therapeutics","lever","fatetherapeutics","health","Cell therapy","","","",[],""),
  ("firecrawl","Firecrawl","ashby","firecrawl","ai","Web data for LLMs","","","",[],""),
  ("fossa","FOSSA","greenhouse","fossainc","devtools","License compliance","","","",[],""),
  ("galaxy-data","Galaxy Data","greenhouse","galaxy","infra","AI data centers","","","",[],""),
  ("galileo","Galileo","greenhouse","galileo","ai","LLM evaluation","","","",[],""),
  ("gather-ai","Gather AI","greenhouse","gatherai","robotics","Warehouse drone inventory","","","",[],""),
  ("generalist-ai","Generalist AI","ashby","generalist","ai","Robotics intelligence","","","",[],""),
  ("genesis-molecular","Genesis Molecular","ashby","genesis","ai","AI drug design","","","",[],""),
  ("gridmatic","Gridmatic","greenhouse","gridmaticinc","ai","Energy trading AI","","","",[],""),
  ("h1","H1","lever","h1","health","Healthcare provider data","","","",[],""),
  ("housecall-pro","Housecall Pro","greenhouse","housecall","saas","Home service business software","","","",[],""),
  ("imply","Imply","greenhouse","imply","devtools","Druid analytics","","","",[],""),
  ("impulse-space","Impulse Space","ashby","impulse","aerospace","In-space transportation","","","",[],""),
  ("isometric","Isometric","ashby","isometric","saas","Carbon removal registry","","","",[],""),
  ("jobber","Jobber","ashby","jobber","saas","Field service management","","","",[],""),
  ("kognitos","Kognitos","ashby","kognitos","ai","Business process automation","","","",[],""),
  ("kojo","Kojo","ashby","kojo","saas","Construction materials procurement","","","",[],""),
  ("kura-oncology","Kura Oncology","greenhouse","kuraoncology","health","Precision medicines","","","",[],""),
  ("labelbox","Labelbox","greenhouse","labelbox","ai","Training data platform","","","",[],""),
  ("lancedb","LanceDB","ashby","lancedb","ai","Multimodal data lake","","","",[],""),
  ("langfuse","Langfuse","ashby","langfuse","ai","LLM engineering platform","","","",[],""),
  ("lightmatter","Lightmatter","greenhouse","lightmatter","ai","Photonic computing","","","",[],""),
  ("litellm","LiteLLM","ashby","litellm","ai","LLM proxy","","","",[],""),
  ("lumos","Lumos","ashby","lumos","infra","App governance","","","",[],""),
  ("lunar-energy","Lunar Energy","greenhouse","lunarenergy","infra","Home energy storage","","","",[],""),
  ("mabl","Mabl","greenhouse","mabl","devtools","Test automation","","","",[],""),
  ("momentic","Momentic","ashby","momentic","ai","AI test automation","","","",[],""),
  ("nintex","Nintex","greenhouse","nintex","saas","Process automation","","","",[],""),
  ("nous-research","Nous Research","ashby","nousresearch","ai","Open model research","","","",[],""),
  ("nozomi-networks","Nozomi Networks","greenhouse","nozominetworks","infra","OT security","","","",[],""),
  ("octant-bio","Octant Bio","greenhouse","octantbio","ai","Drug discovery platform","","","",[],""),
  ("opal-security","Opal Security","ashby","opal","infra","Access control","","","",[],""),
  ("openrouter","OpenRouter","ashby","openrouter","ai","LLM routing","","","",[],""),
  ("openspace","OpenSpace","greenhouse","openspace","ai","Construction reality capture","","","",[],""),
  ("osano","Osano","greenhouse","osano","saas","Data privacy platform","","","",[],""),
  ("oxylabs","Oxylabs","lever","oxylabs","saas","Proxy and scraping","","","",[],""),
  ("pickle-robot","Pickle Robot","lever","picklerobot","robotics","Truck unloading robots","","","",[],""),
  ("pingcap","PingCAP","greenhouse","pingcap","devtools","Distributed SQL database","","","",[],""),
  ("playerzero","PlayerZero","ashby","playerzero","devtools","Software reliability","","","",[],""),
  ("prime-medicine","Prime Medicine","greenhouse","primemedicine","health","Gene editing","","","",[],""),
  ("privateer","Privateer","greenhouse","privateer","aerospace","Space data","","","",[],""),
  ("ranger","Ranger","lever","ranger","ai","AI QA agents","","","",[],""),
  ("raygun","Raygun","smartrecruiters","raygun","devtools","Application monitoring","","","",[],""),
  ("recorded-future","Recorded Future","greenhouse","recordedfuture","infra","Threat intelligence platform","","","",[],""),
  ("roboflow","Roboflow","ashby","roboflow","ai","Computer vision platform","","","",[],""),
  ("runzero","runZero","greenhouse","runzero","infra","Asset discovery","","","",[],""),
  ("sanctuary-ai","Sanctuary AI","ashby","sanctuary","robotics","General-purpose robots","","","",[],""),
  ("scribe-therapeutics","Scribe Therapeutics","ashby","scribe","health","CRISPR engineering","","","",[],""),
  ("sequel-med-tech","Sequel Med Tech","lever","sequel-med-tech","health","Insulin pump technology","","","",[],""),
  ("servicetitan","ServiceTitan","smartrecruiters","servicetitan","saas","Home services software","","","",[],""),
  ("shiru","Shiru","lever","shiru","ai","AI protein discovery","","","",[],""),
  ("siteline","Siteline","greenhouse","siteline","fintech","Subcontractor billing","","","",[],""),
  ("sonarsource","SonarSource","lever","sonarsource","devtools","Code quality and security","","","",[],""),
  ("sonrai-security","Sonrai Security","lever","sonrai-security","infra","Cloud identity security","","","",[],""),
  ("span","Span","ashby","span","infra","Smart electrical panel","","","",[],""),
  ("spire-global","Spire Global","greenhouse","spire","aerospace","Space data analytics","","","",[],""),
  ("stacklok","Stacklok","greenhouse","stacklok","infra","Open source security","","","",[],""),
  ("startree","StarTree","greenhouse","startree","devtools","Real-time analytics","","","",[],""),
  ("superannotate","SuperAnnotate","lever","superannotate","ai","Annotation platform","","","",[],""),
  ("synthego","Synthego","lever","synthego","infra","CRISPR platform","","","",[],""),
  ("tenstorrent","Tenstorrent","greenhouse","tenstorrent","ai","AI processors","","","",[],""),
  ("terra-co2","Terra CO2","ashby","terra","infra","Low-carbon materials","","","",[],""),
  ("tessera-therapeutics","Tessera Therapeutics","greenhouse","tesseratherapeutics","health","Gene writing","","","",[],""),
  ("tetsuwan-scientific","Tetsuwan Scientific","ashby","tetsuwan","robotics","Lab automation robots","","","",[],""),
  ("tines","Tines","greenhouse","tines","devtools","Workflow automation","","","",[],""),
  ("torq","Torq","greenhouse","torq","infra","Security hyperautomation","","","",[],""),
  ("transcend","Transcend","greenhouse","transcendinc","saas","Privacy operations","","","",[],""),
  ("uipath","UiPath","ashby","uipath","saas","Robotic process automation","","","",[],""),
  ("ultralytics","Ultralytics","ashby","ultralytics","ai","Vision model tooling","","","",[],""),
  ("vantage-data-centers","Vantage Data Centers","ashby","vantage","infra","Hyperscale data centers","","","",[],""),
  ("vaulted-deep","Vaulted Deep","ashby","vaulted-deep","infra","Carbon sequestration","","","",[],""),
  ("verve-therapeutics","Verve Therapeutics","greenhouse","verve","health","Gene editing for heart","","","",[],""),
  ("very-good-security","Very Good Security","lever","verygoodsecurity","infra","Data security platform","","","",[],""),
  ...
  # ── 2026-08-31 — non-engineering employers: finance, media, retail, hospitality, law, healthcare systems, civic ──
  ("blackstone","Blackstone","workday","blackstone/wd1/Blackstone_Careers","fintech","Alternative asset manager","","","",[],""),
  ("target","Target","workday","target/wd5/TargetCareers","consumer","Retail","","","",[],""),
  ("major-league-baseball","Major League Baseball","greenhouse","majorleaguebaseball","media","Sports league","","","",[],""),
  ("accenture","Accenture","workday","accenture/wd103/AccentureCareers","saas","Consulting and technology","","","",[],""),
  ("aig","AIG","workday","aig/wd1/Aig","fintech","Insurance","","","",[],""),
  ...
  ("burlington","Burlington","workday","burlington/wd5/BurlingtonCareers","consumer","Off-price retail","","","",[],""),
  ("carmax","CarMax","workday","carmax/wd1/External","marketplace","Used cars","","","",[],""),
  ("carvana","Carvana","greenhouse","carvana","marketplace","Online used cars","","","",[],""),
  ("charles-schwab","Charles Schwab","greenhouse","charles","fintech","Brokerage and banking","","","",[],""),
  ("chipotle","Chipotle","workday","chipotle/wd5/ChipotleCareers","saas","Restaurants","","","",[],""),
  ("christies","Christies","workday","christies/wd3/Christies_Careers","consumer","Auction house","","","",[],""),
  ("cinemark","Cinemark","workday","cinemark/wd1/Cinemark","media","Movie theaters","","","",[],""),
  ("code-org","Code org","greenhouse","codeorg","ed","Computer science education","","","",[],""),
  ("colliers","Colliers","smartrecruiters","colliers","proptech","Commercial real estate","","","",[],""),
  ("constellation-brands","Constellation Brands","ashby","constellation","consumer","Beverage alcohol","","","",[],""),
  ("creative-artists-agency","Creative Artists Agency","workday","caa/wd1/Careers","media","Talent agency","","","",[],""),
  ("diageo","Diageo","workday","diageo/wd3/Diageo_Careers","consumer","Beverage alcohol","","","",[],""),
  ("dutch-bros","Dutch Bros","lever","dutch","saas","Coffee","","","",[],""),
  ("fleishmanhillard","FleishmanHillard","greenhouse","fleishmanhillard","adtech","Public relations","","","",[],""),
  ("forbes","Forbes","greenhouse","forbes","media","Business media","","","",[],""),
  ("four-seasons","Four Seasons","greenhouse","fourseasons","saas","Luxury hotels","","","",[],""),
  ("gensler","Gensler","workday","gensler/wd1/GenslerCareers","proptech","Architecture","","","",[],""),
  ("gimlet-media","Gimlet Media","ashby","gimlet","media","Podcasting","","","",[],""),
  ("girls-who-code","Girls Who Code","lever","girlswhocode","ed","Nonprofit education","","","",[],""),
  ("guggenheim-partners","Guggenheim Partners","workday","guggenheim/wd1/Guggenheim_Careers","fintech","Investment bank","","","",[],""),
  ("iheartmedia","iHeartMedia","smartrecruiters","iheartmedia","media","Audio broadcasting","","","",[],""),
  ("imax","IMAX","workday","imax/wd10/imax-careers","media","Cinema technology","","","",[],""),
  ("j-crew","J Crew","workday","jcrew/wd1/JcrewCareers","consumer","Apparel retail","","","",[],""),
  ("jll","JLL","workday","jll/wd1/JllCareers","proptech","Commercial real estate","","","",[],""),
  ("kenvue","Kenvue","smartrecruiters","kenvue","consumer","Consumer health","","","",[],""),
  ("kering","Kering","workday","kering/wd3/Kering","consumer","Luxury goods","","","",[],""),
  ("lincoln-financial","Lincoln Financial","greenhouse","lincoln","fintech","Insurance","","","",[],""),
  ("lvmh","LVMH","smartrecruiters","lvmh","consumer","Luxury goods","","","",[],""),
  ("markel","Markel","smartrecruiters","markel","fintech","Specialty insurance","","","",[],""),
  ("marriott","Marriott","smartrecruiters","marriottinc","saas","Hotels","","","",[],""),
  ("mars","Mars","workday","mars/wd3/External","consumer","Confectionery and pet care","","","",[],""),
  ("northwestern-mutual","Northwestern Mutual","smartrecruiters","northwesternmutual","fintech","Insurance","","","",[],""),
  ("norwegian-cruise-line","Norwegian Cruise Line","smartrecruiters","norwegiancruiseline","saas","Cruise line","","","",[],""),
  ("pacific-life","Pacific Life","workday","pacificlife/wd1/PacificlifeCareers","fintech","Insurance","","","",[],""),
  ("propublica","ProPublica","greenhouse","propublica","media","Nonprofit journalism","","","",[],""),
  ("raymond-james","Raymond James","workday","raymondjames/wd1/RaymondjamesCareers","fintech","Financial services","","","",[],""),
  ("richemont","Richemont","workday","richemont/wd3/Richemont","consumer","Luxury goods","","","",[],""),
  ("silver-lake","Silver Lake","ashby","silver","fintech","Technology investor","","","",[],""),
  ("skadden","Skadden","workday","skadden/wd5/Skadden_Careers","saas","Law firm","","","",[],""),
  ("starz","Starz","workday","starz/wd5/Starz","media","Premium television","","","",[],""),
  ("stifel","Stifel","smartrecruiters","stifel","fintech","Investment bank","","","",[],""),
  ("t-rowe-price","T Rowe Price","workday","troweprice/wd5/Troweprice","fintech","Asset management","","","",[],""),
  ("turner-construction","Turner Construction","smartrecruiters","turnerconstruction","proptech","Construction","","","",[],""),
  ("universal-health-services","Universal Health Services","greenhouse","universal","health","Hospital system","","","",[],""),
  ("unum","Unum","workday","unum/wd1/External","fintech","Employee benefits","","","",[],""),
  ("wayfair-home","Wayfair Home","smartrecruiters","wayfair","consumer","Online furniture","","","",[],""),
  ("weber-shandwick","Weber Shandwick","greenhouse","webershandwick","adtech","Public relations","","","",[],""),
  ("wegmans","Wegmans","workday","wegmans/wd1/Wegmans","consumer","Grocery","","","",[],""),
  ("williams-sonoma","Williams Sonoma","workday","williams/wd5/External","consumer","Home goods","","","",[],""),
  ("wr-berkley","WR Berkley","lever","wr","fintech","Insurance","","","",[],""),

  # ── 2026-09-08 — 1,000-name sweep, ATS-verified ──
  # Probed with scripts/discover-ats.py rather than guessed: every slug below
  # returned a real board. 245 of 1,000 names resolved; 101 of those were
  # already here under a different display name, leaving these 141.
  # Dropped after checking the board's own posting bodies: ashby:neptune
  # ("Neptune AI" resolves to Neptune the couples' concierge — the same
  # misresolve removed once before), plus two self-duplicate slugs.
  ("bedrock-robotics","Bedrock Robotics","ashby","bedrock-robotics","proptech","construction autonomy","","","",[],""),
  ("forge-global","Forge Global","greenhouse","forgeglobal","saas","private markets","","","",[],""),
  ("stackadapt","StackAdapt","greenhouse","stackadapt","adtech","DSP","","","",[],""),
  ("genalyte","Genalyte","lever","genalyte","health","diagnostics","","","",[],""),
  ("shopmy","ShopMy","greenhouse","shopmy","saas","creator commerce","","","",[],""),
  ("pallet","Pallet","greenhouse","pallet","marketplace","logistics AI","","","",[],""),
  ("nexxen","Nexxen","ashby","nexxen","adtech","adtech","","","",[],""),
  ("postman","Postman","greenhouse","postman","devtools","API platform","","","",[],""),
  ("you-com","You.com","greenhouse","youcom","ai","search AI","","","",[],""),
  ("luma-ai","Luma AI","ashby","lumaai","saas","video models","","","",[],""),
  ("vise","Vise","greenhouse","viseai","fintech","AI wealth management","","","",[],""),
  ("resmed","ResMed","smartrecruiters","resmed","health","medical devices","","","",[],""),
  ("soci","SOCi","greenhouse","soci","saas","local marketing SaaS","","","",[],""),
  ("airspace","Airspace","greenhouse","airspace","marketplace","time-critical logistics","","","",[],""),
  ("brain","Brain Corp","greenhouse","brainlabs","robotics","robotics software","","","",[],""),
  ("solera","Solera","greenhouse","solera","ai","auto claims software","","","",[],""),
  ("encore-capital-group","Encore Capital Group","greenhouse","encore","fintech","consumer finance","","","",[],""),
  ("lpl-financial","LPL Financial","greenhouse","lpl","fintech","wealth platform","","","",[],""),
  ("erasca","Erasca","greenhouse","erasca","health","biotech","","","",[],""),
  ("bionano-genomics","Bionano Genomics","smartrecruiters","bionanogenomics","health","genomics","","","",[],""),
  ("scripps-research","Scripps Research","smartrecruiters","scrippsresearch","ai","research institute","","","",[],""),
  ("acadia-pharmaceuticals","Acadia Pharmaceuticals","greenhouse","acadiapharmaceuticals","health","biotech","","","",[],""),
  ("slope","Slope","ashby","slope","fintech","B2B payments","","","",[],""),
  ("ledge","Ledge","ashby","ledge","fintech","finance automation","","","",[],""),
  ("vira-health","Vira Health","ashby","virahealth","saas","menopause","","","",[],""),
  ("owkin","Owkin","ashby","owkin","ai","AI biology","","","",[],""),
  ("iterative-health","Iterative Health","greenhouse","iterativehealth","ai","GI AI","","","",[],""),
  ("cohere-health","Cohere Health","greenhouse","coherehealth","saas","prior auth","","","",[],""),
  ("anterior","Anterior","ashby","anterior","ai","prior auth AI","","","",[],""),
  ("cherre","Cherre","lever","cherre","proptech","real estate data","","","",[],""),
  ("flip","Flip","ashby","flip","marketplace","apartment marketplace","","","",[],""),
  ("chalk","Chalk","ashby","chalk","saas","feature platform","","","",[],""),
  ("prisma","Prisma","greenhouse","prisma","saas","ORM","","","",[],""),
  ("whop","Whop","ashby","whop","saas","creator commerce","","","",[],""),
  ("quince","Quince","greenhouse","quince","saas","commerce","","","",[],""),
  ("brooklinen","Brooklinen","ashby","brooklinen","consumer","DTC","","","",[],""),
  ("parachute-home","Parachute Home","greenhouse","parachutehome","consumer","DTC","","","",[],""),
  ("velocity-global","Velocity Global","ashby","velocity","saas","global employment","","","",[],""),
  ("fictiv","Fictiv","greenhouse","fictiv","marketplace","manufacturing marketplace","","","",[],""),
  ("xometry","Xometry","greenhouse","xometry","marketplace","manufacturing marketplace","","","",[],""),
  ("backbone","Backbone","ashby","backbone","saas","supply chain software","","","",[],""),
  ("ellevation-education","Ellevation Education","lever","ellevationeducation","saas","K-12","","","",[],""),
  ("voodoo","Voodoo","ashby","voodoo","gaming","mobile games","","","",[],""),
  ("oneleet","Oneleet","ashby","oneleet","saas","security compliance","","","",[],""),
  ("sentra","Sentra","ashby","sentra","saas","data security","","","",[],""),
  ("ketch","Ketch","greenhouse","ketch","saas","privacy","","","",[],""),
  ("cue-health","Cue Health","smartrecruiters","cuehealthinc","health","diagnostics","","","",[],""),
  ("homebot","Homebot","ashby","homebot","proptech","proptech","","","",[],""),
  ("bloomerang","Bloomerang","greenhouse","bloomerang","saas","nonprofit CRM","","","",[],""),
  ("athena-security","Athena Security","greenhouse","athena","saas","computer vision","","","",[],""),
  ("experian","Experian","smartrecruiters","experian","fintech","credit bureau","","","",[],""),
  ("equityzen","EquityZen","greenhouse","equityzen","saas","secondary markets","","","",[],""),
  ("fox-corporation","Fox Corporation","greenhouse","fox","media","media","","","",[],""),
  ("industry-dive","Industry Dive","smartrecruiters","industrydive","media","B2B media","","","",[],""),
  ("simulmedia","Simulmedia","lever","simulmedia","adtech","TV advertising","","","",[],""),
  ("zefr","Zefr","ashby","zefr","saas","brand safety","","","",[],""),
  ("wunderkind","Wunderkind","greenhouse","wunderkind","saas","marketing","","","",[],""),
  ("optimove","Optimove","greenhouse","optimove","saas","CRM marketing","","","",[],""),
  ("amperity","Amperity","greenhouse","amperity","saas","CDP","","","",[],""),
  ("blueshift","Blueshift","greenhouse","blueshift","saas","CDP","","","",[],""),
  ("simon-data","Simon Data","ashby","simondata","saas","CDP","","","",[],""),
  ("axsome-therapeutics","Axsome Therapeutics","greenhouse","axsometherapeutics","health","biotech","","","",[],""),
  ("cellarity","Cellarity","greenhouse","cellarity","health","biotech","","","",[],""),
  ("flagship-pioneering","Flagship Pioneering","greenhouse","flagshippioneeringinc","health","biotech","","","",[],""),
  ("devoted-health","Devoted Health","smartrecruiters","devotedhealth","health","payer","","","",[],""),
  ("clover-health","Clover Health","greenhouse","cloverhealth","health","payer","","","",[],""),
  ("healthverity","HealthVerity","greenhouse","healthverity","health","health data","","","",[],""),
  ("opentable","OpenTable NYC","greenhouse","opentable","saas","reservations","","","",[],""),
  ("life-house","Life House","lever","life","saas","hotel software","","","",[],""),
  ("cortex","Cortex","greenhouse","cortex","saas","service catalog","","","",[],""),
  ("cypress","Cypress","greenhouse","cypressio","devtools","testing","","","",[],""),
  ("unleash","Unleash","smartrecruiters","unleash","saas","feature flags","","","",[],""),
  ("speakeasy","Speakeasy","ashby","speakeasy","devtools","API tooling","","","",[],""),
  ("kong","Kong","ashby","kong","devtools","API gateway","","","",[],""),
  ("apollo-graphql","Apollo GraphQL","ashby","apollo-graphql","saas","GraphQL","","","",[],""),
  ("svix","Svix","ashby","svix","saas","webhooks","","","",[],""),
  ("light-and-wonder","Light and Wonder","ashby","light","gaming","gaming","","","",[],""),
  ("genies","Genies","ashby","genies","saas","avatars","","","",[],""),
  ("arcturus-therapeutics","Arcturus Therapeutics","ashby","arcturus","health","biotech","","","",[],""),
  ("gossamer-bio","Gossamer Bio","greenhouse","gossamerbio","health","biotech","","","",[],""),
  ("prometheus-biosciences","Prometheus Biosciences","ashby","prometheus","health","biotech","","","",[],""),
  ("protagonist-therapeutics","Protagonist Therapeutics","greenhouse","protagonist","health","biotech","","","",[],""),
  ("vectara","Vectara","greenhouse","vectara","saas","RAG platform","","","",[],""),
  ("steel-dev","Steel dev","ashby","steel","devtools","browser API","","","",[],""),
  ("imbue","Imbue","greenhouse","imbue","ai","agents","","","",[],""),
  ("sweet-security","Sweet Security","greenhouse","sweetsecurity","saas","runtime security","","","",[],""),
  ("apiiro","Apiiro","greenhouse","apiiro","saas","appsec","","","",[],""),
  ("bcg-x","BCG X","greenhouse","bcg","saas","consulting","","","",[],""),
  ("tcs","TCS NYC","greenhouse","tcs","saas","IT services","","","",[],""),
  ("cityswift","Cityswift","greenhouse","cityswift","saas","transit analytics","","","",[],""),
  ("givedirectly","GiveDirectly","greenhouse","givedirectly","saas","nonprofit","","","",[],""),
  ("civis-analytics","Civis Analytics","greenhouse","civisanalytics","saas","data science","","","",[],""),
  ("zenoti","Zenoti","greenhouse","zenoti","saas","spa software","","","",[],""),
  ("boulevard","Boulevard","greenhouse","boulevard","saas","salon software","","","",[],""),
  ("sondermind","SonderMind","ashby","sondermind","health","therapy","","","",[],""),
  ("calm","Calm","greenhouse","calm","saas","meditation","","","",[],""),
  ("real","Real","ashby","real","health","therapy","","","",[],""),
  ("nutrafol","Nutrafol","greenhouse","nutrafol","health","hair health","","","",[],""),
  ("prose","Prose","ashby","prose","ai","haircare","","","",[],""),
  ("bubble-skincare","Bubble Skincare","greenhouse","bubbleskincare","consumer","beauty","","","",[],""),
  ("summer-fridays","Summer Fridays","greenhouse","summer","consumer","beauty","","","",[],""),
  ("glow-recipe","Glow Recipe","ashby","glow","consumer","beauty","","","",[],""),
  ("act-and-acre","Act and Acre","ashby","act","ai","haircare","","","",[],""),
  ("wrapbook","Wrapbook","ashby","wrapbook","saas","production payroll","","","",[],""),
  ("monumental","Monumental","ashby","monumental","robotics","construction robotics","","","",[],""),
  ("built-robotics","Built Robotics","ashby","built-robotics","saas","autonomous equipment","","","",[],""),
  ("rescale","Rescale","ashby","rescale","infra","simulation cloud","","","",[],""),
  ("fetch-robotics","Fetch Robotics","greenhouse","fetch","robotics","warehouse robotics","","","",[],""),
  ("geotab","Geotab","greenhouse","geotab","saas","telematics","","","",[],""),
  ("echo-global-logistics","Echo Global Logistics","greenhouse","echo","marketplace","freight","","","",[],""),
  ("fiddler-ai","Fiddler AI","ashby","fiddler-ai","saas","model monitoring","","","",[],""),
  ("nomic-ai","Nomic AI","ashby","nomic","saas","embeddings","","","",[],""),
  ("stability-ai","Stability AI","greenhouse","stabilityai","saas","generative models","","","",[],""),
  ("pika-labs","Pika Labs","ashby","pika","saas","video models","","","",[],""),
  ("genmo","Genmo","ashby","genmo","ai","video AI","","","",[],""),
  ("viggle","Viggle","ashby","viggle","ai","video AI","","","",[],""),
  ("krea-ai","Krea AI","ashby","krea","ai","image AI","","","",[],""),
  ("recraft","Recraft","ashby","recraft","ai","design AI","","","",[],""),
  ("photoroom","Photoroom","ashby","photoroom","saas","image editing","","","",[],""),
  ("picsart","Picsart","greenhouse","picsart","saas","creative tools","","","",[],""),
  ("canva","Canva NYC","smartrecruiters","canva","saas","design","","","",[],""),
  ("webflow","Webflow","greenhouse","webflow","saas","web builder","","","",[],""),
  ("duda","Duda","greenhouse","duda","saas","web builder","","","",[],""),
  ("sanity","Sanity","ashby","sanity","saas","headless CMS","","","",[],""),
  ("storyblok","Storyblok","greenhouse","storyblok","saas","headless CMS","","","",[],""),
  ("builder-io","Builder io","greenhouse","builder","saas","visual CMS","","","",[],""),
  ("influxdata","InfluxData","ashby","influxdata","saas","time series","","","",[],""),
  ("dremio","Dremio","greenhouse","dremio","saas","lakehouse","","","",[],""),
  ("collate","Collate","lever","collate","saas","metadata","","","",[],""),
  ("portable-io","Portable io","greenhouse","portable","saas","ELT","","","",[],""),
  ("matillion","Matillion","lever","matillion","saas","ETL","","","",[],""),
  ("duffel","Duffel","ashby","duffel","devtools","travel API","","","",[],""),
  ("swapcard","Swapcard","lever","swapcard","saas","events","","","",[],""),
  ("circle-so","Circle so","ashby","circle","saas","community platform","","","",[],""),
  ("zola","Zola","greenhouse","zola","saas","weddings","","","",[],""),
  ("the-knot-worldwide","The Knot Worldwide","greenhouse","theknotworldwide","saas","weddings","","","",[],""),
  ("minted","Minted","lever","minted","saas","stationery","","","",[],""),
  ("chatbooks","Chatbooks","greenhouse","chatbooks","saas","photo books","","","",[],""),
  ("vestiaire-collective","Vestiaire Collective","lever","vestiairecollective","marketplace","resale","","","",[],""),
  ("rebag","Rebag","greenhouse","rebag","marketplace","luxury resale","","","",[],""),
  ("goat-group","GOAT Group","greenhouse","goatgroup","marketplace","sneaker marketplace","","","",[],""),
  # ── 2026-09-17 — 1,597-name sweep, ATS-verified ──
  # Probed with scripts/discover-ats.py across four batches; 522 names
  # resolved to a live board, 143 of those were already here under another
  # display name or slug, and 82 were slug collisions confirmed against each
  # board's own posting bodies and registered in discover-ats.py's COLLIDING
  # so they cannot come back. That leaves these 297. Two boards (ashby:spruce,
  # smartrecruiters:cahoot) carried nothing that identified their company
  # either way and were left out rather than guessed at.
  ("above-lending","Above Lending","lever","abovelending","fintech","debt consolidation","","","",[],""),
  ("aftership","AfterShip","greenhouse","aftership","saas","shipment tracking","","","",[],""),
  ("agtonomy","Agtonomy","lever","agtonomy","robotics","farm autonomy","","","",[],""),
  ("alchemer","Alchemer","greenhouse","alchemer","saas","survey platform","","","",[],""),
  ("angi","Angi","ashby","angi","marketplace","home services","","","",[],""),
  ("antimetal","Antimetal","ashby","antimetal","devtools","AWS cost optimization","","","",[],""),
  ("apella","Apella","ashby","apella","health","operating room AI","","","",[],""),
  ("appsflyer","AppsFlyer","greenhouse","appsflyer","adtech","mobile attribution","","","",[],""),
  ("arbor","Arbor","ashby","arbor","climate","carbon removal","","","",[],""),
  ("arcadia-science","Arcadia Science","greenhouse","arcadiascience","health","research institute","","","",[],""),
  ("arize-ai","Arize AI","greenhouse","arizeai","ai","ML observability","","","",[],""),
  ("arta-finance","Arta Finance","ashby","artafinance","fintech","digital wealth management","","","",[],""),
  ("assured-allies","Assured Allies","ashby","assured","health","aging-in-place insurance","","","",[],""),
  ("atomic","Atomic","ashby","atomic","fintech","payroll connectivity","","","",[],""),
  ("authzed","Authzed","ashby","authzed","devtools","authorization service","","","",[],""),
  ("autotrader","Autotrader","greenhouse","autotrader","marketplace","car listings","","","",[],""),
  ("avride","Avride","greenhouse","avride","robotics","delivery robots","","","",[],""),
  ("awin-global","Awin Global","greenhouse","awin","adtech","affiliate network","","","",[],""),
  ("aya-healthcare","Aya Healthcare","greenhouse","ayahealthcare","marketplace","travel nurse staffing","","","",[],""),
  ("bankrate","Bankrate","greenhouse","bankrate","fintech","rate comparison","","","",[],""),
  ("basecamp-research","Basecamp Research","ashby","basecamp-research","health","biodiversity genomics","","","",[],""),
  ("beacon","Beacon","ashby","beaconai","fintech","fintech infrastructure","","","",[],""),
  ("beacon-biosignals","Beacon Biosignals","greenhouse","beaconbiosignals","health","EEG neurodiagnostics","","","",[],""),
  ("believe","Believe","smartrecruiters","believe","media","music distribution","","","",[],""),
  ("bia","Bia","lever","biaenergy","climate","LatAm energy management","","","",[],""),
  ("bidgely","Bidgely","ashby","bidgely-inc","saas","utility energy analytics","","","",[],""),
  ("biofourmis","Biofourmis","greenhouse","biofourmis","health","remote patient care","","","",[],""),
  ("block-renovation","Block Renovation","greenhouse","blockrenovation","proptech","home renovation","","","",[],""),
  ("blueland","Blueland","lever","blueland","consumer","refillable cleaning","","","",[],""),
  ("boulder-care","Boulder Care","greenhouse","bouldercare","health","opioid telehealth","","","",[],""),
  ("branch-insurance","Branch Insurance","ashby","branchinsurance","fintech","bundled home and auto","","","",[],""),
  ("branch-metrics","Branch Metrics","greenhouse","branchmetrics","adtech","mobile deep linking","","","",[],""),
  ("bringg","Bringg","greenhouse","bringg","saas","delivery orchestration","","","",[],""),
  ("budderfly","Budderfly","greenhouse","budderfly","climate","energy-as-a-service","","","",[],""),
  ("businessolver","Businessolver","greenhouse","businessolver","saas","benefits administration","","","",[],""),
  ("butterfly-mx","Butterfly MX","ashby","butterflymx","proptech","video intercoms","","","",[],""),
  ("callrail","CallRail","greenhouse","callrail","saas","call tracking","","","",[],""),
  ("canvas-medical","Canvas Medical","lever","canvasmedical","health","EHR for clinics","","","",[],""),
  ("captura","Captura","greenhouse","captura","climate","ocean carbon capture","","","",[],""),
  ("carbon-direct","Carbon Direct","greenhouse","carbondirect","climate","carbon advisory","","","",[],""),
  ("cardiologs","Cardiologs","lever","cardiologs","health","ECG analysis AI","","","",[],""),
  ("careem","Careem","greenhouse","careem","marketplace","MENA super app","","","",[],""),
  ("cargado","Cargado","ashby","cargado","saas","cross-border freight","","","",[],""),
  ("cargurus","CarGurus","greenhouse","cargurus","marketplace","car shopping","","","",[],""),
  ("cascade-climate","Cascade Climate","lever","cascade-climate","climate","climate science","","","",[],""),
  ("chownow","ChowNow","lever","chownow","marketplace","restaurant ordering","","","",[],""),
  ("clarity-ai","Clarity AI","greenhouse","clarityai","saas","sustainability data","","","",[],""),
  ("clarity-pediatrics","Clarity Pediatrics","ashby","claritypediatrics","health","pediatric ADHD care","","","",[],""),
  ("clearco","Clearco","ashby","clearco","fintech","ecommerce funding","","","",[],""),
  ("cline-ai","Cline AI","greenhouse","cline","devtools","AI coding agent","","","",[],""),
  ("cloudzero","Cloudzero","ashby","cloudzero","devtools","cloud cost intelligence","","","",[],""),
  ("coastal-community-bank","Coastal Community Bank","ashby","coastal","fintech","banking-as-a-service","","","",[],""),
  ("coco-delivery","Coco Delivery","ashby","cocodelivery","robotics","sidewalk delivery","","","",[],""),
  ("coder","Coder","ashby","coder","devtools","cloud dev environments","","","",[],""),
  ("companycam","CompanyCam","ashby","companycam","saas","contractor photo app","","","",[],""),
  ("confiant","Confiant","ashby","confiant","adtech","ad security","","","",[],""),
  ("contentsquare","Contentsquare","lever","contentsquare","saas","experience analytics","","","",[],""),
  ("coram-ai","Coram AI","ashby","coram-ai","ai","video security AI","","","",[],""),
  ("coterie-insurance","Coterie Insurance","greenhouse","coterieinsurance","fintech","small business insurance","","","",[],""),
  ("cowbell-cyber","Cowbell Cyber","greenhouse","cowbellcyber","fintech","cyber insurance","","","",[],""),
  ("creatify","Creatify","ashby","creatify","ai","AI video ads","","","",[],""),
  ("crunchyroll","Crunchyroll","greenhouse","crunchyroll","media","anime streaming","","","",[],""),
  ("dandelion-energy","Dandelion Energy","ashby","dandelion","climate","geothermal heating","","","",[],""),
  ("dave","Dave","ashby","dave","fintech","neobank","","","",[],""),
  ("daybreak","Daybreak","greenhouse","daybreakhealth","health","youth mental health","","","",[],""),
  ("deep-sky","Deep Sky","lever","deepsky","climate","carbon removal sites","","","",[],""),
  ("dialpad","Dialpad","greenhouse","dialpad","saas","AI business phone","","","",[],""),
  ("didomi","Didomi","lever","didomi","saas","consent management","","","",[],""),
  ("dovetail","Dovetail","ashby","dovetail","saas","user research platform","","","",[],""),
  ("dust-tt","Dust TT","ashby","dust","ai","enterprise AI agents","","","",[],""),
  ("e2b","E2B","ashby","e2b","devtools","agent cloud sandboxes","","","",[],""),
  ("elation-health","Elation Health","greenhouse","elationhealth","health","primary care EHR","","","",[],""),
  ("enveda-biosciences","Enveda Biosciences","lever","enveda","health","nature-derived drugs","","","",[],""),
  ("extropic","Extropic","ashby","extropic","infra","thermodynamic compute","","","",[],""),
  ("factorial-energy","Factorial Energy","greenhouse","factorialenergy","climate","solid-state batteries","","","",[],""),
  ("faraday-future","Faraday Future","greenhouse","faradayfuture","automotive","electric vehicles","","","",[],""),
  ("farther-finance","Farther Finance","greenhouse","fartherfinance","fintech","tech-enabled wealth mgmt","","","",[],""),
  ("feathery","Feathery","ashby","feathery","saas","form builder","","","",[],""),
  ("fervo-energy","Fervo Energy","greenhouse","fervoenergy","climate","enhanced geothermal","","","",[],""),
  ("fi","Fi","lever","fi","consumer","GPS dog collars","","","",[],""),
  ("fieldwire","Fieldwire","greenhouse","fieldwire","saas","construction field mgmt","","","",[],""),
  ("figure-technology","Figure Technology","greenhouse","figure","fintech","tokenized lending","","","",[],""),
  ("finary","Finary","ashby","finary","fintech","wealth tracking","","","",[],""),
  ("fingerprint","Fingerprint","greenhouse","fingerprint","security","device identification","","","",[],""),
  ("finix","Finix","lever","finix","fintech","payments infrastructure","","","",[],""),
  ("finout","Finout","ashby","finout","devtools","cloud cost management","","","",[],""),
  ("five9","Five9","greenhouse","five9","saas","cloud contact center","","","",[],""),
  ("fizz","Fizz","ashby","fizz","fintech","student credit card","","","",[],""),
  ("flo-health","Flo Health","greenhouse","flohealth","health","cycle tracking app","","","",[],""),
  ("fly-io","Fly.io","lever","fly","infra","app hosting at the edge","","","",[],""),
  ("fonoa","Fonoa","ashby","fonoa","fintech","global tax automation","","","",[],""),
  ("footprint","Footprint","ashby","footprint","security","KYC and onboarding","","","",[],""),
  ("form-energy","Form Energy","ashby","formenergy","climate","multi-day iron batteries","","","",[],""),
  ("freestar","Freestar","greenhouse","freestar","adtech","publisher monetization","","","",[],""),
  ...
  ("greenlight-financial","Greenlight Financial","lever","greenlight","fintech","kids debit card","","","",[],""),
  ("griffin-bank","Griffin Bank","ashby","griffin","fintech","UK banking platform","","","",[],""),
  ("group14","Group14","greenhouse","group14","climate","silicon battery material","","","",[],""),
  ("grove-collaborative","Grove Collaborative","greenhouse","grovecollaborative","consumer","sustainable household","","","",[],""),
  ...
  ("homelight","HomeLight","greenhouse","homelight","proptech","agent matching","","","",[],""),
  ("homzmart","Homzmart","smartrecruiters","homzmart","marketplace","furniture marketplace","","","",[],""),
  ("honeydew-care","Honeydew Care","ashby","honeydew","health","acne telederm","","","",[],""),
  ("hover","Hover","greenhouse","hover","proptech","property AI from photos","","","",[],""),
  ("human-security","HUMAN Security","ashby","human","security","bot and fraud defense","","","",[],""),
  ("hysata","Hysata","greenhouse","hysata","climate","efficient electrolyzers","","","",[],""),
  ("ibotta","Ibotta","ashby","ibotta","consumer","cash back rewards","","","",[],""),
  ("immersive-touch","Immersive Touch","greenhouse","immersive","health","surgical VR planning","","","",[],""),
  ("incode","Incode","greenhouse","incode","security","identity verification","","","",[],""),
  ("infosum","InfoSum","greenhouse","infosum","adtech","data collaboration","","","",[],""),
  ("inkeep","Inkeep","ashby","inkeep","ai","docs search agents","","","",[],""),
  ("inmobi","InMobi","greenhouse","inmobi","adtech","mobile ad platform","","","",[],""),
  ("insomniac-games","Insomniac Games","greenhouse","insomniac","gaming","console game studio","","","",[],""),
  ("insurify","Insurify","greenhouse","insurify","marketplace","insurance comparison","","","",[],""),
  ("intersystems","InterSystems","greenhouse","intersystems","health","health data platform","","","",[],""),
  ("intro-js","Intro.js","ashby","intro","devtools","product tours","","","",[],""),
  ("invoca","Invoca","greenhouse","invoca","saas","revenue call analytics","","","",[],""),
  ("iris-telehealth","Iris Telehealth","smartrecruiters","iristelehealth","health","behavioral telepsychiatry","","","",[],""),
  ("jobnimbus","Jobnimbus","greenhouse","jobnimbus","saas","contractor CRM","","","",[],""),
  ("judge-me","Judge.me","smartrecruiters","judgeme","saas","Shopify product reviews","","","",[],""),
  ("jumio","Jumio","greenhouse","jumio","security","identity verification","","","",[],""),
  ("kargo-global","Kargo Global","greenhouse","kargo","adtech","mobile brand ads","","","",[],""),
  ("katapult","Katapult","ashby","katapult-labs","fintech","lease-to-own","","","",[],""),
  ("kochava","Kochava","lever","kochava","adtech","mobile measurement","","","",[],""),
  ("lead-bank","Lead Bank","ashby","leadbank","fintech","embedded banking","","","",[],""),
  ("lendingtree","LendingTree","greenhouse","lendingtree","marketplace","loan marketplace","","","",[],""),
  ("letsgetchecked","LetsGetChecked","smartrecruiters","letsgetchecked","health","at-home lab tests","","","",[],""),
  ("level-home","Level Home","ashby","level","proptech","smart locks","","","",[],""),
  ("levels","Levels","ashby","levels","health","metabolic health app","","","",[],""),
  ("levelten-energy","LevelTen Energy","greenhouse","leveltenenergy","climate","clean power marketplace","","","",[],""),
  ("liftoff-mobile","Liftoff Mobile","greenhouse","liftoff","adtech","app growth platform","","","",[],""),
  ("lila-sciences","Lila Sciences","greenhouse","lilasciences","ai","AI for scientific discovery","","","",[],""),
  ("lindus-health","Lindus Health","ashby","lindus","health","clinical trial CRO","","","",[],""),
  ("liquid-ai","Liquid AI","ashby","liquid-ai","ai","liquid foundation models","","","",[],""),
  ("logz-io","Logz.io","lever","logz","devtools","observability platform","","","",[],""),
  ("luma-health","Luma Health","greenhouse","lumahealth","health","patient engagement","","","",[],""),
  ("lyric","Lyric","ashby","lyric","health","claims accuracy AI","","","",[],""),
  ("maestro-qa","Maestro QA","smartrecruiters","maestroqa","saas","support QA","","","",[],""),
  ("may-mobility","May Mobility","greenhouse","maymobility","automotive","autonomous shuttles","","","",[],""),
  ("maze","Maze","ashby","mazedesign","saas","product research","","","",[],""),
  ("medely","Medely","ashby","medely","marketplace","per-diem clinical staffing","","","",[],""),
  ("mediaocean","Mediaocean","greenhouse","mediaocean","adtech","ad spend platform","","","",[],""),
  ("minio","MinIO","greenhouse","minio","infra","object storage","","","",[],""),
  ("modern-animal","Modern Animal","greenhouse","modernanimal","health","vet clinics","","","",[],""),
  ("moloco","Moloco","greenhouse","moloco","adtech","ML ad bidding","","","",[],""),
  ("moniepoint","Moniepoint","greenhouse","moniepoint","fintech","African business banking","","","",[],""),
  ("monzo","Monzo","greenhouse","monzo","fintech","UK digital bank","","","",[],""),
  ("motional","Motional","greenhouse","motional","automotive","autonomous driving","","","",[],""),
  ("mujin","Mujin","lever","mujininc","robotics","warehouse robot control","","","",[],""),
  ("musixmatch","Musixmatch","lever","musixmatch","media","music metadata","","","",[],""),
  ("n26","N26","greenhouse","n26","fintech","European digital bank","","","",[],""),
  ("nash","Nash","ashby","nash","saas","delivery API","","","",[],""),
  ("natera","Natera","greenhouse","natera","health","genetic testing","","","",[],""),
  ("national-debt-relief","National Debt Relief","smartrecruiters","nationaldebtrelief","fintech","debt settlement","","","",[],""),
  ("naughty-dog","Naughty Dog","greenhouse","naughtydog","gaming","PlayStation game studio","","","",[],""),
  ("nearmap","Nearmap","smartrecruiters","nearmap","saas","aerial imagery","","","",[],""),
  ("nerdwallet","NerdWallet","ashby","nerdwallet","fintech","personal finance guide","","","",[],""),
  ("netomi","Netomi","lever","netomi","ai","customer service AI","","","",[],""),
  ("neurotrack","Neurotrack","smartrecruiters","neurotrack","health","cognitive assessment","","","",[],""),
  ("new-western","New Western","lever","newwestern","proptech","investment property","","","",[],""),
  ("nextech","Nextech","lever","nextech","health","specialty practice EHR","","","",[],""),
  ("nice","NICE","greenhouse","nice","saas","contact center software","","","",[],""),
  ("nira-energy","Nira Energy","greenhouse","niraenergy","climate","solar siting analytics","","","",[],""),
  ("nirmata","Nirmata","greenhouse","nirmata","devtools","Kubernetes policy","","","",[],""),
  ("noah-medical","Noah Medical","greenhouse","noahmedical","health","surgical robotics","","","",[],""),
  ("novo-bank","Novo Bank","ashby","novo","fintech","small business banking","","","",[],""),
  ("noyo","Noyo","ashby","noyo","fintech","benefits data API","","","",[],""),
  ("nudge-security","Nudge Security","ashby","nudgesecurity","security","SaaS discovery","","","",[],""),
  ("obsidian-security","Obsidian Security","greenhouse","obsidiansecurity","security","SaaS security posture","","","",[],""),
  ("okendo","Okendo","lever","okendo","saas","ecommerce reviews","","","",[],""),
  ("omnisend","Omnisend","lever","omnisend","saas","ecommerce email and SMS","","","",[],""),
  ("onyx-ai","Onyx AI","ashby","onyx","ai","enterprise AI search","","","",[],""),
  ("opaque-systems","Opaque Systems","greenhouse","opaquesystems","security","confidential computing","","","",[],""),
  ("oportun","Oportun","greenhouse","oportun","fintech","inclusive lending","","","",[],""),
  ("oscilar","Oscilar","ashby","oscilar","fintech","AI risk decisioning","","","",[],""),
  ("palmpay","PalmPay","smartrecruiters","palmpay","fintech","African mobile payments","","","",[],""),
  ("partnerize","Partnerize","greenhouse","partnerize","adtech","partner marketing","","","",[],""),
  ("passport","Passport","ashby","passport","fintech","mobile parking payments","","","",[],""),
  ("patronus-ai","Patronus AI","ashby","patronus","ai","LLM evaluation","","","",[],""),
  ("pattern-ag","Pattern Ag","lever","pattern","saas","soil biology analytics","","","",[],""),
  ("pearl-health","Pearl Health","ashby","pearlhealth","health","value-based primary care","","","",[],""),
  ("periodic-labs","Periodic Labs","ashby","periodic-labs","ai","AI for materials science","","","",[],""),
  ("permutive","Permutive","ashby","permutive","adtech","publisher audience data","","","",[],""),
  ("pipe-technologies","Pipe Technologies","greenhouse","pipetechnologies","fintech","revenue-based capital","","","",[],""),
  ("pointcentral","PointCentral","greenhouse","pointcentral","proptech","property automation","","","",[],""),
  ("pointclickcare","PointClickCare","lever","pointclickcare","health","senior care records","","","",[],""),
  ("porter-run","Porter Run","greenhouse","porter","devtools","Kubernetes deploys","","","",[],""),
  ("possible-finance","Possible Finance","ashby","possible-finance","fintech","small-dollar lending","","","",[],""),
  ("prenuvo","Prenuvo","greenhouse","prenuvo","health","whole-body MRI","","","",[],""),
  ("prime-intellect","Prime Intellect","ashby","primeintellect","ai","decentralized training","","","",[],""),
  ("profluent-bio","Profluent Bio","greenhouse","profluent","health","protein design AI","","","",[],""),
  ("pronto-ai","Pronto AI","greenhouse","pronto","robotics","mining autonomy","","","",[],""),
  ("quaise-energy","Quaise Energy","greenhouse","quaise","climate","deep geothermal drilling","","","",[],""),
  ("qualtrics","Qualtrics","greenhouse","qualtrics","saas","experience management","","","",[],""),
  ("quanthealth","QuantHealth","greenhouse","quanthealth","health","trial simulation AI","","","",[],""),
  ("quantum-metric","Quantum Metric","lever","quantummetric","saas","digital experience data","","","",[],""),
  ("quip","Quip","greenhouse","quip","consumer","oral care","","","",[],""),
  ("rapidai","RapidAI","lever","rapidai","health","stroke imaging AI","","","",[],""),
  ("raptive","Raptive","ashby","raptive","adtech","creator ad network","","","",[],""),
  ("redox-engine","Redox Engine","lever","redoxengine","health","healthcare data exchange","","","",[],""),
  ("redwood-materials","Redwood Materials","greenhouse","redwoodmaterials","climate","battery recycling","","","",[],""),
  ("renoviso","Renoviso","smartrecruiters","renoviso","proptech","home improvement","","","",[],""),
  ("rewind-ai","Rewind AI","ashby","rewind","ai","personal memory search","","","",[],""),
  ("rhombus-systems","Rhombus Systems","lever","rhombus-systems","security","cloud video security","","","",[],""),
  ("rialtic","Rialtic","greenhouse","rialtic","health","payment integrity","","","",[],""),
  ("rise-credit","Rise Credit","lever","rise","fintech","consumer installment loans","","","",[],""),
  ("rivr-robotics","Rivr Robotics","lever","rivr","robotics","legged delivery robots","","","",[],""),
  ("roku","Roku","greenhouse","roku","media","streaming platform","","","",[],""),
  ("roo","Roo","greenhouse","roo","marketplace","vet relief staffing","","","",[],""),
  ("roofr","Roofr","greenhouse","roofr","proptech","roofing quotes","","","",[],""),
  ("runwise","Runwise","greenhouse","runwise","proptech","boiler controls","","","",[],""),
  ("science37","Science37","greenhouse","science37","health","decentralized trials","","","",[],""),
  ("securiti","Securiti","smartrecruiters","securiti","security","data governance","","","",[],""),
  ("seed-health","Seed Health","greenhouse","seed","consumer","probiotics","","","",[],""),
  ("sentilink","Sentilink","ashby","sentilink","fintech","synthetic fraud detection","","","",[],""),
  ("serif-health","Serif Health","ashby","serifhealth","health","price transparency data","","","",[],""),
  ("service-fusion","Service Fusion","smartrecruiters","servicefusion","saas","field service software","","","",[],""),
  ("ses-ai","SES AI","greenhouse","sesai","climate","lithium-metal batteries","","","",[],""),
  ("sesame-care","Sesame Care","ashby","sesame","marketplace","cash-pay doctor visits","","","",[],""),
  ("shipmonk","Shipmonk","greenhouse","shipmonk","saas","ecommerce fulfillment","","","",[],""),
  ("signos","Signos","greenhouse","signos","health","glucose weight app","","","",[],""),
  ("sila-nanotechnologies","Sila Nanotechnologies","greenhouse","silananotechnologies","climate","silicon anode material","","","",[],""),
  ("simplisafe","SimpliSafe","greenhouse","simplisafe","consumer","home security","","","",[],""),
  ("singular","Singular","ashby","singular","adtech","marketing analytics","","","",[],""),
  ("skin-clique","Skin Clique","greenhouse","skinclique","health","in-home dermatology","","","",[],""),
  ("skydance","Skydance","lever","skydance","media","film and TV studio","","","",[],""),
  ("smartasset","SmartAsset","greenhouse","smartasset","fintech","financial advisor match","","","",[],""),
  ("solid-power","Solid Power","greenhouse","solidpower","climate","solid-state batteries","","","",[],""),
  ("solink","Solink","ashby","solink","security","video and POS analytics","","","",[],""),
  ("spade","Spade","ashby","spade","fintech","transaction enrichment","","","",[],""),
  ("speechify","Speechify","greenhouse","speechify","consumer","text to speech","","","",[],""),
  ("spoton","SpotOn","ashby","spoton","fintech","restaurant POS","","","",[],""),
  ("sprig","Sprig","ashby","sprig","saas","in-product surveys","","","",[],""),
  ("stackblitz","StackBlitz","greenhouse","stackblitz","devtools","in-browser dev envs","","","",[],""),
  ("stand-insurance","Stand Insurance","ashby","standinsurance","fintech","wildfire home insurance","","","",[],""),
  ("stedi","Stedi","ashby","stedi","health","EDI for healthcare","","","",[],""),
  ("stellar-health","Stellar Health","ashby","stellar-health","health","value-based care nudges","","","",[],""),
  ("step-mobile","Step Mobile","greenhouse","step","fintech","teen banking","","","",[],""),
  ("stigg","Stigg","ashby","stigg","devtools","pricing and packaging","","","",[],""),
  ("system1","System1","lever","system1","adtech","performance marketing","","","",[],""),
  ("tala","Tala","lever","tala","fintech","emerging market lending","","","",[],""),
  ("tamara","Tamara","greenhouse","tamara","fintech","MENA buy now pay later","","","",[],""),
  ("tango","Tango","ashby","tango","saas","how-to guide capture","","","",[],""),
  ("tapcart","Tapcart","ashby","tapcart","saas","Shopify mobile apps","","","",[],""),
  ("taptap-send","Taptap Send","ashby","taptapsend","fintech","remittances","","","",[],""),
  ("tebra","Tebra","greenhouse","tebra","health","practice management","","","",[],""),
  ("teleo","Teleo","lever","teleo","robotics","heavy equipment autonomy","","","",[],""),
  ("ternary","Ternary","ashby","ternary","devtools","cloud cost management","","","",[],""),
  ("texture-energy","Texture Energy","ashby","texture","saas","energy device data","","","",[],""),
  ("thanx","Thanx","greenhouse","thanx","saas","restaurant loyalty","","","",[],""),
  ("thimble-insurance","Thimble Insurance","lever","thimble","fintech","small business insurance","","","",[],""),
  ("thndr","Thndr","ashby","thndr","fintech","MENA investing app","","","",[],""),
  ("thought-machine","Thought Machine","ashby","thought-machine","fintech","cloud core banking","","","",[],""),
  ("thumbtack","Thumbtack","ashby","thumbtack","marketplace","home services","","","",[],""),
  ("too-lost","Too Lost","lever","too-lost","media","music rights SaaS","","","",[],""),
  ("torc-robotics","Torc Robotics","greenhouse","torcrobotics","automotive","autonomous trucking","","","",[],""),
  ("triplelift","TripleLift","greenhouse","triplelift","adtech","native ad exchange","","","",[],""),
  ("trulioo","Trulioo","ashby","trulioo","security","identity verification","","","",[],""),
  ("turbopuffer","Turbopuffer","ashby","turbopuffer","infra","serverless vector search","","","",[],""),
  ("turvo","Turvo","lever","turvo","saas","supply chain platform","","","",[],""),
  ("twelve-benefit","Twelve Benefit","ashby","twelve","climate","CO2 to jet fuel","","","",[],""),
  ("typeform","Typeform","greenhouse","typeform","saas","conversational forms","","","",[],""),
  ("ultimate-ai","Ultimate AI","greenhouse","ultimate","ai","support automation","","","",[],""),
  ("umba","Umba","smartrecruiters","umba","fintech","African digital bank","","","",[],""),
  ("unbounce","Unbounce","greenhouse","unbounce","saas","landing page builder","","","",[],""),
  ("upbound-group","Upbound Group","greenhouse","upbound","fintech","lease-to-own retail","","","",[],""),
  ("upgrade","Upgrade","greenhouse","upgrade","fintech","credit and banking","","","",[],""),
  ("verdigris","Verdigris","lever","verdigris","saas","building energy AI","","","",[],""),
  ("veriff","Veriff","greenhouse","veriff","security","identity verification","","","",[],""),
  ("verisoul","Verisoul","ashby","verisoul","security","fake account detection","","","",[],""),
  ("vetcove","Vetcove","ashby","vetcove","health","veterinary supply platform","","","",[],""),
  ("viant-technology","Viant Technology","greenhouse","vianttechnology","adtech","programmatic DSP","","","",[],""),
  ("viome","Viome","lever","viome","health","microbiome testing","","","",[],""),
  ("vori-health","Vori Health","ashby","vori","health","virtual musculoskeletal","","","",[],""),
  ("wayflyer","Wayflyer","ashby","wayflyer","fintech","ecommerce funding","","","",[],""),
  ("wellsaid-labs","WellSaid Labs","greenhouse","wellsaidlabs","ai","synthetic voice","","","",[],""),
  ("wisetack","Wisetack","greenhouse","wisetack","fintech","point-of-sale financing","","","",[],""),
  ("witness-ai","Witness AI","ashby","witnessai","security","AI usage governance","","","",[],""),
  ("workwave","WorkWave","lever","workwave","saas","field service software","","","",[],""),
  ("yes-energy","Yes Energy","greenhouse","yesenergy","saas","power market data","","","",[],""),
  ("yieldmo","Yieldmo","greenhouse","yieldmo","adtech","ad format exchange","","","",[],""),
  ("zero-homes","Zero Homes","ashby","zerohomes","proptech","home electrification","","","",[],""),
  ("zero-labs","Zero Labs","ashby","zero","climate","clean energy data","","","",[],""),
  ("zesty-ai","Zesty AI","greenhouse","zestyai","saas","property risk analytics","","","",[],""),
  ("zeta","Zeta","lever","zeta","fintech","cloud core banking","","","",[],""),
  # ── 2026-09-20 — Los Angeles sweep, ATS-verified ──
  # 1,665 LA-area names drafted and probed with scripts/discover-ats.py.
  # 324 hit a live board, 107 of those were already here, and 49 were slug
  # collisions confirmed against each board's own postings and registered in
  # discover-ats.py. 16 more were read and left out: nothing on the board
  # settled the company, or the board led with defence work. That leaves
  # these 126 (two of the 128 turned out to be companies already here under
  # a dead slug, so those rows were repointed instead), of which 29 show an
  # LA-area location today.
  # Hit rate was far below the 2026-09-17 sweep's: LA's employers lean
  # entertainment, retail and agencies, which mostly do not run a supported
  # public ATS, and the 1,935 rows above already cover much of its tech.
  ("2k-games","2K Games","greenhouse","2k","gaming","sports and AAA games","","","",[],""),
  ("31st-union","31st Union","greenhouse","31stunion","gaming","2K's Bay Area studio","","","",[],""),
  ("amount","Amount","greenhouse","amount","fintech","digital loan origination","","","",[],""),
  ("antora-energy","Antora Energy","greenhouse","antora","climate","thermal energy storage","","","",[],""),
  ("argonaut-agency","Argonaut Agency","lever","argonaut","media","creative agency","","","",[],""),
  ("atera","Atera","smartrecruiters","atera","saas","IT management platform","","","",[],""),
  ("automox","Automox","greenhouse","automox","security","endpoint patching","","","",[],""),
  ("bitmovin","Bitmovin","greenhouse","bitmovin","media","video encoding and player","","","",[],""),
  ("bobbie","Bobbie","greenhouse","bobbie","consumer","infant formula","","","",[],""),
  ("brand-new-school","Brand New School","greenhouse","brandnewschool","media","motion design studio","","","",[],""),
  ("brotherhood-crusade","Brotherhood Crusade","lever","brotherhoodcrusade","ed","South LA youth programs","","","",[],""),
  ("bubble","Bubble","ashby","bubble","devtools","no-code app builder","","","",[],""),
  ("byd-north-america","BYD North America","greenhouse","byd","automotive","electric buses and trucks","","","",[],""),
  ("byheart","ByHeart","greenhouse","byheart","consumer","infant formula","","","",[],""),
  ("caruso-affiliated","Caruso Affiliated","lever","carusoaffiliated","proptech","retail real estate","","","",[],""),
  ("clubhouse","Clubhouse","ashby","clubhouse","consumer","live audio rooms","","","",[],""),
  ("contentstack","Contentstack","greenhouse","contentstack","saas","headless CMS","","","",[],""),
  ("cybereason","Cybereason","greenhouse","cybereason","security","endpoint detection","","","",[],""),
  ("czinger","Czinger","greenhouse","czinger","automotive","3D-printed hypercars","","","",[],""),
  ("d-matrix","d-Matrix","ashby","d-matrix","infra","AI inference chips","","","",[],""),
  ("dawn-aerospace","Dawn Aerospace","greenhouse","dawnaerospace","aerospace","reusable spaceplane","","","",[],""),
  ("directive-consulting","Directive Consulting","ashby","directive","media","B2B performance marketing","","","",[],""),
  ("doma","Doma","greenhouse","doma","proptech","title and escrow tech","","","",[],""),
  ("electra-aero","Electra Aero","greenhouse","electraaero","aerospace","short-takeoff aircraft","","","",[],""),
  ("elroy-air","Elroy Air","lever","elroyair","aerospace","autonomous cargo aircraft","","","",[],""),
  ("endava","Endava","smartrecruiters","endava","saas","software engineering services","","","",[],""),
  ("eplus","ePlus","greenhouse","eplusinc","saas","IT solutions provider","","","",[],""),
  ("equitas-academy","Equitas Academy","lever","equitasacademy","ed","LA charter schools","","","",[],""),
  ("expeditors","Expeditors","smartrecruiters","expeditors","marketplace","global freight forwarding","","","",[],""),
  ("faherty-brand","Faherty Brand","greenhouse","fahertybrand","consumer","apparel","","","",[],""),
  ("fantasy","Fantasy","lever","fantasy","media","product design studio","","","",[],""),
  ("fashion-nova","Fashion Nova","greenhouse","fashionnova","consumer","fast fashion","","","",[],""),
  ("flutterflow","FlutterFlow","ashby","flutterflow","devtools","visual app builder","","","",[],""),
  ("fuzz-productions","Fuzz Productions","smartrecruiters","fuzzproductions","saas","mobile app studio","","","",[],""),
  ("gcore","Gcore","smartrecruiters","gcore","infra","edge cloud and CDN","","","",[],""),
  ("gearbox-software","Gearbox Software","greenhouse","gearbox","gaming","Borderlands studio","","","",[],""),
  ("ghost-vfx","Ghost VFX","smartrecruiters","ghostvfx","media","visual effects","","","",[],""),
  ("good-american","Good American","lever","goodamerican","consumer","inclusive denim","","","",[],""),
  ("grey","Grey","greenhouse","grey","media","global ad agency","","","",[],""),
  ("groundfloor","Groundfloor","greenhouse","groundfloorfinance","fintech","real estate lending","","","",[],""),
  ("guardz","Guardz","greenhouse","guardz","security","SMB cyber protection","","","",[],""),
  ("gymshark","Gymshark","greenhouse","gymshark","consumer","fitness apparel","","","",[],""),
  ...
  ("hypebeast","Hypebeast","lever","hypebeast","media","streetwear publishing","","","",[],""),
  ("inscribe-ai","Inscribe AI","ashby","inscribeai","fintech","document fraud detection","","","",[],""),
  ("intuitive-surgical","Intuitive Surgical","smartrecruiters","intuitive","health","surgical robotics","","","",[],""),
  ("jamf","Jamf","greenhouse","jamf","saas","Apple device management","","","",[],""),
  ("jetzero","JetZero","greenhouse","jetzero","aerospace","blended-wing airliner","","","",[],""),
  ("kioxia-america","Kioxia America","smartrecruiters","kioxia","infra","flash memory and SSDs","","","",[],""),
  ("kipp-socal","KIPP SoCal","lever","kippsocal","ed","LA charter network","","","",[],""),
  ("knix","Knix","lever","knix","consumer","intimates and activewear","","","",[],""),
  ("krafton-americas","Krafton Americas","greenhouse","kraftonamericas","gaming","PUBG publisher","","","",[],""),
  ("lens","LENS","ashby","lens","ai","crash-prevention vision","","","",[],""),
  ("little-spoon","Little Spoon","greenhouse","littlespoon","consumer","baby food delivery","","","",[],""),
  ("loft-orbital","Loft Orbital","lever","loftorbital","aerospace","satellites as a service","","","",[],""),
  ("loop-subscriptions","Loop Subscriptions","smartrecruiters","loopsubscriptions","saas","Shopify subscriptions","","","",[],""),
  ("lumanu","Lumanu","ashby","lumanu","fintech","creator payments","","","",[],""),
  ("magnopus","Magnopus","lever","magnopus","media","immersive experiences","","","",[],""),
  ("masimo","Masimo","smartrecruiters","masimo","health","patient monitoring","","","",[],""),
  ("maxwell-lender","Maxwell Lender","greenhouse","maxwell","fintech","mortgage lending platform","","","",[],""),
  ("media-arts-lab","Media Arts Lab","greenhouse","mediaartslab","media","Apple's ad agency","","","",[],""),
  ("mercari","Mercari","greenhouse","mercari","marketplace","secondhand marketplace","","","",[],""),
  ("meridianlink","MeridianLink","ashby","meridianlink","fintech","lending software","","","",[],""),
  ("microchip","Microchip","smartrecruiters","microchip","infra","microcontrollers","","","",[],""),
  ("midpen-housing","MidPen Housing","greenhouse","midpenhousing","proptech","affordable housing","","","",[],""),
  ("mubi","MUBI","ashby","mubi","media","arthouse streaming","","","",[],""),
  ("n8n","n8n","ashby","n8n","devtools","workflow automation","","","",[],""),
  ("nanit","Nanit","greenhouse","nanit","consumer","smart baby monitor","","","",[],""),
  ("netgear","NETGEAR","ashby","netgear","infra","networking hardware","","","",[],""),
  ("nextdoor","Nextdoor","greenhouse","nextdoor","consumer","neighborhood network","","","",[],""),
  ("nintendo-of-america","Nintendo of America","greenhouse","nintendo","gaming","console games","","","",[],""),
  ("northbeam","Northbeam","greenhouse","northbeam","adtech","marketing attribution","","","",[],""),
  ("offerup","OfferUp","greenhouse","offerup","marketplace","local resale","","","",[],""),
  ("once-upon-a-farm","Once Upon a Farm","lever","onceuponafarm","consumer","organic kids food","","","",[],""),
  ("pacaso","Pacaso","greenhouse","pacaso","proptech","co-owned second homes","","","",[],""),
  ("passes","Passes","ashby","passes","consumer","creator subscriptions","","","",[],""),
  ("peak-energy","Peak Energy","greenhouse","peakenergy","climate","sodium-ion storage","","","",[],""),
  ("pmg","PMG","greenhouse","pmg","adtech","media and creative agency","","","",[],""),
  ("polar-analytics","Polar Analytics","ashby","polaranalytics","saas","ecommerce analytics","","","",[],""),
  ("pulse-biosciences","Pulse Biosciences","greenhouse","pulsebiosciences","health","nanosecond pulsed field","","","",[],""),
  ("q-apel-medical","Q Apel Medical","smartrecruiters","qapelmedical","health","neurovascular catheters","","","",[],""),
  ("quadric","Quadric","ashby","quadric","infra","edge AI processors","","","",[],""),
  ("qualia-labs","Qualia Labs","greenhouse","qualia","proptech","real estate closing","","","",[],""),
  ("radius-agent","Radius Agent","smartrecruiters","radiusagent","proptech","agent network","","","",[],""),
  ("rebuy-engine","Rebuy Engine","ashby","rebuy","saas","ecommerce personalization","","","",[],""),
  ("recharge","Recharge","ashby","recharge","saas","Shopify subscriptions","","","",[],""),
  ("rexford-industrial","Rexford Industrial","greenhouse","rexfordindustrial","proptech","SoCal industrial REIT","","","",[],""),
  ("rodeo-fx","Rodeo FX","smartrecruiters","rodeofx","media","visual effects","","","",[],""),
  ("rondo-energy","Rondo Energy","greenhouse","rondoenergy","climate","industrial heat batteries","","","",[],""),
  ("rpa","RPA","greenhouse","rpa","media","Santa Monica ad agency","","","",[],""),
  ("rumble-video","Rumble Video","greenhouse","rumble","media","video platform","","","",[],""),
  ("sandbox-vr","Sandbox VR","lever","sandboxvr","gaming","location-based VR","","","",[],""),
  ("second-dinner","Second Dinner","ashby","seconddinner","gaming","Marvel Snap studio","","","",[],""),
  ("shein","SHEIN","greenhouse","shein","consumer","fast fashion","","","",[],""),
  ("shockwave-medical","Shockwave Medical","smartrecruiters","shockwavemedical","health","calcium-modifying catheters","","","",[],""),
  ("sk-hynix-america","SK hynix America","greenhouse","skhynixamerica","infra","memory semiconductors","","","",[],""),
  ("skio","Skio","lever","skio","saas","Shopify subscriptions","","","",[],""),
  ("snapdocs","Snapdocs","ashby","snapdocs","proptech","digital mortgage closing","","","",[],""),
  ("spotter","Spotter","greenhouse","spotter","media","creator capital","","","",[],""),
  ("starfish-space","Starfish Space","ashby","starfish-space-inc","aerospace","satellite servicing","","","",[],""),
  ("suger","Suger","lever","suger","saas","cloud marketplace selling","","","",[],""),
  ("sunnova","Sunnova","greenhouse","sunnova","climate","residential solar","","","",[],""),
  ("tanium","Tanium","greenhouse","tanium","security","endpoint management","","","",[],""),
  ("tecovas","Tecovas","greenhouse","tecovas","consumer","western boots","","","",[],""),
  ("thirdlove","ThirdLove","greenhouse","thirdlove","consumer","intimates","","","",[],""),
  ("thunkable","Thunkable","lever","thunkable","devtools","no-code mobile apps","","","",[],""),
  ("tilt-five","Tilt Five","smartrecruiters","tiltfive","gaming","tabletop AR","","","",[],""),
  ("todyl","Todyl","ashby","todyl","security","SMB security platform","","","",[],""),
  ("trace3","Trace3","greenhouse","trace3","saas","IT consulting","","","",[],""),
  ("triple-whale","Triple Whale","greenhouse","triplewhale","saas","ecommerce analytics","","","",[],""),
  ("turbotenant","TurboTenant","greenhouse","turbotenant","proptech","landlord software","","","",[],""),
  ("twitch","Twitch","greenhouse","twitch","media","live streaming","","","",[],""),
  ("unreal-snacks","Unreal Snacks","greenhouse","unrealsnacks","consumer","better-for-you candy","","","",[],""),
  ("vista-del-mar","Vista Del Mar","greenhouse","vistadelmar","health","LA child services","","","",[],""),
  ("visual-concepts","Visual Concepts","greenhouse","visualconcepts","gaming","NBA 2K studio","","","",[],""),
  ("viz-media","VIZ Media","greenhouse","vizmedia","media","manga and anime","","","",[],""),
  ("wistia","Wistia","ashby","wistia","saas","business video hosting","","","",[],""),
  ("wpromote","Wpromote","lever","wpromote","adtech","LA digital agency","","","",[],""),
  ("yubo","Yubo","ashby","yubo","consumer","social discovery app","","","",[],""),
  ("zambezi","Zambezi","lever","zambezi","media","LA creative agency","","","",[],""),
]
